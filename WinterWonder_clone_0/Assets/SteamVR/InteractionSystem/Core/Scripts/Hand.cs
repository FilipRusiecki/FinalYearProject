...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        private PlayerVRRR playerInstance;
        ...
        public Vector3 GetTrackedObjectVelocity(float timeOffset = 0)
        {
            ...
            {
                if (timeOffset == 0)
                    return PlayerVRRR.instance.trackingOriginTransform.TransformVector(trackedObject.GetVelocity());
                else
                {
                    Vector3 velocity;
                    ...
                    return PlayerVRRR.instance.trackingOriginTransform.TransformVector(velocity);
                }
            }
        ...
        public Vector3 GetTrackedObjectAngularVelocity(float timeOffset = 0)
        {
            ...
            {
                if (timeOffset == 0)
                    return PlayerVRRR.instance.trackingOriginTransform.TransformDirection(trackedObject.GetAngularVelocity());
                else
                {
                    Vector3 velocity;
                    Vector3 angularVelocity;
                    ...
                    trackedObject.GetVelocitiesAtTimeOffset(timeOffset, out velocity, out angularVelocity);
                    return PlayerVRRR.instance.trackingOriginTransform.TransformDirection(angularVelocity);
                }
            }
        ...
        public void GetEstimatedPeakVelocities(out Vector3 velocity, out Vector3 angularVelocity)
        {
            ...
            velocity = PlayerVRRR.instance.trackingOriginTransform.TransformVector(velocity);
            angularVelocity = PlayerVRRR.instance.trackingOriginTransform.TransformDirection(angularVelocity);
        }
        ...
        protected virtual IEnumerator Start()
        {
            ...
            playerInstance = PlayerVRRR.instance;
            if (!playerInstance)
            {
