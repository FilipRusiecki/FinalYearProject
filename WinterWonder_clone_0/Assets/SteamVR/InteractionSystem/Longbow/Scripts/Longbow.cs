	...
	public class Longbow : MonoBehaviour
	{
		...
		private void HandAttachedUpdate( Hand hand )
		{
			...
			if ( nocked )
			{
				...
				Vector3 arrowNockTransformToHeadset = ( (PlayerVRRR.instance.hmdTransform.position + ( Vector3.down * 0.05f ) ) - arrowHand.arrowNockTransform.parent.position ).normalized;
